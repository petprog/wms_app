...
class TopUpAddWaterSecondScreen extends StatelessWidget {
  static const routeName = "/top_up_add_water_second_screen";
  const TopUpAddWaterSecondScreen({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              TopUpDetailsCard(
                ...
                cardBackgroundColor: Color.fromRGBO(245, 252, 255, 1),
              ),
              SizedBox(
                height: 30,
              ),
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context)
                          .pushNamed(TopUpAddWaterThirdScreen.routeName);
                    },
                    child: Text(
                      "Buy Now",
                      style: TextStyle(
