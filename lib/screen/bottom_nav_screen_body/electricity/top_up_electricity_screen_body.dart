...
class TopUpElectricityScreenBody extends StatelessWidget {
  const TopUpElectricityScreenBody({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            const TopUpDetailsCard(
              ...
              cardBackgroundColor: Color.fromRGBO(69, 62, 107, 1),
            ),
            const SizedBox(
              height: 20,
            ),
            const TopUpRate(
              ...
              koboPerLiter: '13,55',
              rateIconColor: Color.fromRGBO(174, 184, 254, 1),
              rateTextColor: Color.fromRGBO(69, 62, 107, 1),
            ),
            const SizedBox(
              height: 20,
            ),
