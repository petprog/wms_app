...
class UsageElectricityScreenBody extends StatelessWidget {
  const UsageElectricityScreenBody({Key? key}) : super(key: key);
          ...
          children: [
            SizedBox(
              ...
              child: UsageWeeklyMonthlyYearlyTabController(
                primaryColor: Color.fromRGBO(69, 62, 107, 1),
              ),
            ),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  UsageWaterConsumed(
                    ...
                    rate: "10/2",
                    energyColorText: Color.fromRGBO(69, 62, 107, 1),
                  ),
                ],
              ),
            )
