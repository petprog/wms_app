...
class TopUpAddGasSecondScreen extends StatelessWidget {
  static const routeName = "/top_up_add_gas_second_screen";
  const TopUpAddGasSecondScreen({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              TopUpDetailsCard(
                ...
                cardBackgroundColor: Color.fromRGBO(255, 243, 241, 1),
              ),
              SizedBox(
                height: 30,
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                        primary: Color.fromRGBO(231, 111, 81, 1),
                        padding: EdgeInsets.all(16)),
                    onPressed: () {
                      Navigator.of(context)
                          .pushNamed(TopUpAddGasThirdScreen.routeName);
                    },
                    child: Text(
                      "Buy Now",
                      style: TextStyle(
