...
class UsageGasScreenBody extends StatelessWidget {
  const UsageGasScreenBody({Key? key}) : super(key: key);
          ...
          children: [
            SizedBox(
              ...
              child: UsageWeeklyMonthlyYearlyTabController(
                primaryColor: Color.fromRGBO(231, 111, 81, 1),
              ),
            ),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  UsageWaterConsumed(
                    ...
                    rate: "10/2",
                    energyColorText: Color.fromRGBO(231, 111, 81, 1),
                  )
                ],
              ),
            )
